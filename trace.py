...
_SOURCE_PATTERNS: list[tuple[str, list[str]]] = [
    ("okta",              ["/api/v1/logs", "/api/v1/users", "/api/v1/org", "/api/v1/meta", "/api/v1/imaas/"]),
    ("netskope",          ["/api/v2/"]),
    ...
    ("proofpoint",        ["/v2/siem/"]),
    ("cisco_duo",         ["/epm/api/auth/epm/logon"]),
    ...
    ("checkpoint_ngfw",   ["/web_api/"]),
    ("cortex_xdr",        ["/public_api/"]),
    ("mimecast",          ["/api/ttp/", "/api/login/", "/api/account/"]),
    ("vectra_ai",         ["/api/v3.3/"]),
    ("extrahop_revealx",  ["/api/v1/detections"]),
    ("palo_alto_ngfw",    ["/api/v2/threat-logs"]),
]
